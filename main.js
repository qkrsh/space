window.onload = function init()
{
    ...
    const flakeMaterial = new THREE.PointsMaterial({
        size:4,
        map: TextureLoader.load("snow2.png"),
    ...
    //DOG
        ...
        loader2.load('./ball/scene.gltf', function(gltf){
        ...
        animate();
         ...
         loader3.load('./notebook/scene.gltf', function(gltf){
         ...
         const planetTexture4 = new THREE.TextureLoader().load("planetTexture.jpeg");
    ...
    const planetTexture2 = new THREE.TextureLoader().load("planetTexture.jpeg");
    ...
    planetMesh2.scale.set(10.5, 10.5, 10.5);
     ...
     const planetTexture3 = new THREE.TextureLoader().load("sun.png");
    ...
    const planeTexture = new THREE.TextureLoader().load("sh_basic.png");
